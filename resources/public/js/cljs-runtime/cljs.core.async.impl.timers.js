...
var i_33501 = (0);
while(true){
if((i_33501 < arr.length)){
(arr[i_33501] = null);

var G__33502 = (i_33501 + (1));
i_33501 = G__33502;
continue;
} else {
}
...
var i_33515 = (self__.level + (1));
while(true){
if((i_33515 <= (new_level + (1)))){
(update[i_33515] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_33517 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_33517[i]));
} else {
x__$2.forward.push((((i < links_33517.length))?(links_33517[i]):null));
}

if((i < links_33517.length)){
(links_33517[i] = x__$2);
} else {
links_33517.push(x__$2);
}
...
var i_33531 = (0);
while(true){
if((i_33531 <= self__.level)){
var links_33532 = (update[i_33531]).forward;
if((x__$1 === (((i_33531 < links_33532.length))?(links_33532[i_33531]):null))){
(links_33532[i_33531] = (x__$1.forward[i_33531]));

var G__33533 = (i_33531 + (1));
i_33531 = G__33533;
continue;
} else {
var G__33534 = (i_33531 + (1));
i_33531 = G__33534;
continue;
}
} else {

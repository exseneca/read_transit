...
var o28591 = temp__5802__auto__;
var temp__5802__auto____$1 = (o28591["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o28592 = temp__5802__auto____$1;
return (o28592["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__28344__auto__ = f;
return (o__28344__auto__["toString"]).call(o__28344__auto__);
} else {
return "";
}
}catch (e28593){var _ = e28593;
return "";
}});
...
try{var o__28344__auto___28909 = t;
(o__28344__auto___28909["cljs$lang$ctorPrWriter"]).call(o__28344__auto___28909,t,writer);
}catch (e28600){var __28910 = e28600;
}
...
var char_code = (function (){var o__28344__auto__ = (new String(char$));
return (o__28344__auto__["charCodeAt"]).call(o__28344__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__28344__auto__ = String;
return (o__28344__auto__["fromCharCode"]).call(o__28344__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28633 = num_code;
switch (G__28633) {
case (1):
return (185);
...
var o__28344__auto__ = String;
return (o__28344__auto__["fromCharCode"]).call(o__28344__auto__,superscript_code);
});
/**
...
}catch (e28657){var _e__28352__auto__ = e28657;
return false;
}})())){
...
var vec__28658 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28658,(0),null);
...
var len__5769__auto___28930 = arguments.length;
var i__5770__auto___28931 = (0);
while(true){
if((i__5770__auto___28931 < len__5769__auto___28930)){
args__5775__auto__.push((arguments[i__5770__auto___28931]));

var G__28932 = (i__5770__auto___28931 + (1));
i__5770__auto___28931 = G__28932;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28690){
var vec__28695 = p__28690;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28695,(0),null);
...
var G__28933 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28934 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28933;
remaining_tokens = G__28934;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28681){
var G__28683 = cljs.core.first(seq28681);
var seq28681__$1 = cljs.core.next(seq28681);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28683,seq28681__$1);
}));
...
var vec__28709 = cljs.core.split_with((function (p1__28708_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28708_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28709,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28709,(1),null);
...
var vec__28715 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28715,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28715,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28946 = cljs.core.rest(remaining_tokens);
var G__28947 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28946;
name_tokens = G__28947;
continue;
} else {
...
var vec__28755 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28755,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28755,(1),null);
var vec__28758 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28758,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28758,(1),null);
var vec__28761 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28761,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28761,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28761,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28761,(3),null);
...
var vec__28775 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28775,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28775,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28775,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28775,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28775,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28775,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__28778 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28778,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28778,(1),null);
var vec__28782 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28782,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28782,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28788 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28788) : devtools.munging.parse_fn_info_deep.call(null,G__28788));
})()));
}
} else {
return fn_info;
...
var G__28962 = (arity + (1));
var G__28963 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28807){
var vec__28809 = p__28807;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28809,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28809,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28820_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28820_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28821_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28821_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28831){
var vec__28832 = p__28831;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28832,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28828){
var G__28829 = cljs.core.first(seq28828);
var seq28828__$1 = cljs.core.next(seq28828);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28829,seq28828__$1);
}));
...
var map__28851 = options;
var map__28851__$1 = cljs.core.__destructure_map(map__28851);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28851__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28851__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28851__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28851__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28852 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28852,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28852,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28852,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28852,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28852,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28852,(5),null);
...
var o__28344__auto__ = f;
return (o__28344__auto__["getBasis"]).call(o__28344__auto__);
});
/**
...
}catch (e28861){var _e__28352__auto__ = e28861;
...
var G__28989 = (obj[cljs.core.first(path)]);
var G__28990 = cljs.core.rest(path);
obj = G__28989;
path = G__28990;
continue;
} else {
...
var _STAR_ = (function (accum,p__28872){
var vec__28873 = p__28872;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28873,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28873,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28879){
var vec__28881 = p__28879;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28881,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28881,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28881,(2),null);
...
var post_process = (function (p__28896){
var vec__28897 = p__28896;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28897,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28897,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28891_SHARP_){
return (obj[cljs.core.first(p1__28891_SHARP_)]);
}),sorted_matches);

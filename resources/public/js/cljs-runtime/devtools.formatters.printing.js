...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29001){
var G__29002 = cljs.core.first(seq29001);
var seq29001__$1 = cljs.core.next(seq29001);
var G__29003 = cljs.core.first(seq29001__$1);
var seq29001__$2 = cljs.core.next(seq29001__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29002,G__29003,seq29001__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29014_SHARP_){
return (!((cljs.core.meta(p1__29014_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29030__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e29031){var _e__28352__auto__ = e29031;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e29033){var _e__28352__auto__ = e29033;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__29038 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__29039 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__29039);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29043__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__29038);
}});
...
var temp__5802__auto___29078 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___29078)){
var managed_print_level_29079 = temp__5802__auto___29078;
var _STAR_print_level_STAR__orig_val__29048_29080 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29049_29081 = managed_print_level_29079;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29049_29081);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__29045_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__29045_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29048_29080);
}} else {
job_fn();
}
